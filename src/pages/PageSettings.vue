<template>
  <q-page padding>
    ...
    <q-list bordered padding>
      ...
      <q-item v-ripple tag="label" @click="visitOurWebsite">
        <q-item-section>
      ...
      <q-item v-ripple tag="label" @click="emailUs">
        <q-item-section>
...
export default {
  ...
  methods: {
    ...
    emailUs() {
      window.location.href = 'mailto:hello@awesometodo.com?subjet=Awesome Todo Feedback'
    }
  }
}
</script>
